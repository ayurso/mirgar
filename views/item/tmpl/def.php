...
<?php	
	echo '<div class="title_top info"><p style="font-weight:500; font-size:1.7rem;">Обращение № <span style="color:tomato;">'.$item->id.'</span> от '.date('d-m-Y',$date_start).' подано в '.date('H:i',$date_start).'</p><h2>'.$item->name.'</h2>'; 
