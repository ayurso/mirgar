				...
				echo '<div class="row_ua">';
					echo '<div class="row_ua1"><div class="row_ua1_in">';
						...
						echo '<div class="col_ua public_status"><div class="col_ua_in">';
							...
							echo '<div class="col_ua_row">№ '.$i->id.' от <span>'.DJClassifiedsTheme::formatDate(strtotime($i->date_start),'',$par->get('date_format_type',0)).'</span></div>';
