...
<form action="index.php" method="post" class="form-validate" name="djForm" id="djForm"  enctype="multipart/form-data">
        <div class="additem_djform">
            ...
            <div class="djform_row">
                ...
                <!-- Знак вопроса-->
                <label class = "my_label Tips1" for="name" id="name-lbl" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_TITLE_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /></label>
            ...
            <div class="djform_row">                
				...
				*/
                ...
                <label class = "my_label Tips1" for="cat_0" id="cat_0-lbl" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_CATEGORY_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /> </label>
                <div class="clear_both"></div>
            </div>
 ...
 <!--тут были типы-->
    		...
    		<div class="djform_row">
                ...
                <label class = "my_label Tips1" for="reg_0" id="reg_0-lbl" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_LOCALIZATION_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /></label>
                <div class="clear_both"></div>
            </div>  
            <?php }else{ ?>
            ...
            <?php if($par->get('show_address','1')){?>
	            <div class="djform_row">
	                ...
	                <label class = "my_label Tips1" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_ADDRESS_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /></label>
	                <div class="clear_both"></div> 
	            </div>
            <?php } ?>      
			...
			if($par->get('durations_list','') && $id==0 && count($this->days)){
	    		...
	    		<div class="djform_row">
					...
					<label class = "my_label Tips1" for="exp_days" id="exp_days-lbl" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_EXPIRE_AFTER_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /></label>
	                <div class="clear_both"></div>
	            </div>                
            <?php }else if($id>0){
    		...
    		<div class="djform_row">                
                ...
                <label class = "my_label Tips1" for="intro_desc" id="intro_desc-lbl" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_INTRO_DESCRIPTION_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /></label>
                <div class="clear_both"></div>
            </div>
            <?php } ?>
    		<div class="djform_row">
                ...
                <div class="djform_field">
                	...
                	<?php 
                		...
                		$this->item->description = strip_tags($this->item->description,$a_tags); ?>
  				        <textarea id="description" name="description" rows="5" cols="55" class="inputbox my_opisanie" ><?php echo $this->item->description; ?></textarea>
                	<?php }			   
                	?>                  
                </div>
                <label class = "my_label Tips1" title="<?php echo JTEXT::_('COM_DJCLASSIFIEDS_DESCRIPTION_TOOLTIP')?>"><img src="<?php echo JURI::base(true) ?>/components/com_djclassifieds/assets/images/tip.png" alt="?" /></label>
                <div class="clear_both"></div>
            </div>
